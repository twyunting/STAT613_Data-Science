...
First plot:  Even the line shows a **positive** correlation 
Second plot: Even the line shows a **negative** correlation and a curve would show more 
```{r}
collegeData %>%
